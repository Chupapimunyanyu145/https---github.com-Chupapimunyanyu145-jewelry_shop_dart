...
class AppColors {
  ...
  static const Color gray5 = Color(0xFFEFEFFA);
  ...
  static const Color orange = Color(0xFFFF2D55);
  static const Color pink = Color(0xFFFF2D55);
  static const Color purple = Color(0xFF5856D6);
  static const Color tealBlue = Color(0xFF5ACBFA);
  static const Color yellow = Color(0xFFFFCC00);
  static const Color colorBurn = Color(0xFFFFFFFF);
}